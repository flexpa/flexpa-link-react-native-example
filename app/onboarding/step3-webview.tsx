...
//       const openerUrl =
//         Platform.OS === 'ios' ? 'com.flexpahealth://open' : 'com.flexpahealth://open';

//       // Build the FlexpaLink URL with the correct format based on example
//       const flexpaUrl = `https://link.flexpa.com/?publishableKey=${encodeURIComponent(publishableKey)}&openerUrl=${encodeURIComponent(openerUrl)}&strict=false&autoExit=true&skipSyncing=false&skipExplainer=false&user=${encodedUser}&requestedResources=&usage=ONE_TIME`;
...
//       const result = await WebBrowser.openBrowserAsync(flexpaUrl);
